...
<tileset name="sketches2-0 tiles and monsters" tilewidth="16" tileheight="16" tilecount="64" columns="8">
 <image source="../Assets/Images/sketches2- tiles and monsters.png" width="128" height="128"/>
 <tile id="2">
